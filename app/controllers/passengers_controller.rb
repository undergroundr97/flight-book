class PassengersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @passenger.update(passenger_params)
        format.html { redirect_to @passenger, notice: "Passenger was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to passengers_path, notice: "Passenger was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_passenger
      @passenger = Passenger.find(params.expect(:id))
    end
