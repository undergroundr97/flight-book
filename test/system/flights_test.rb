...
class FlightsTest < ApplicationSystemTestCase
  ...
  test "should create flight" do
    ...
    fill_in "Flightduration", with: @flight.flightduration
    fill_in "Startdatetime", with: @flight.startdatetime
  ...
  test "should update Flight" do
    ...
    fill_in "Arrival", with: @flight.arrival
    fill_in "Departure", with: @flight.departure
    fill_in "Flightduration", with: @flight.flightduration.to_s
    fill_in "Startdatetime", with: @flight.startdatetime.to_s
